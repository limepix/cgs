...
public class RenderService {
	...
	private void renderMatrix(BitMatrix matrix, int size, ServletOutputStream outputStream) {
	    ...
	    png.getMetadata().setText(PngChunkTextVar.KEY_Author, "limepix");
	    png.getMetadata().setText(PngChunkTextVar.KEY_Title, "cgs");
	    png.getMetadata().setText(PngChunkTextVar.KEY_Software, "devshots-cgs");
	    png.getMetadata().setText(PngChunkTextVar.KEY_Comment, "Uses ZXing (http://code.google.com/p/zxing/) and pngj (http://code.google.com/p/pngj/)");
